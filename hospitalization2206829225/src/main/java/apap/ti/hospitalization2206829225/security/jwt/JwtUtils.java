package apap.ti.hospitalization2206829225.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${hospitalization2206829225.app.jwtSecret}")
    private String jwtSecret;

    @Value("${hospitalization2206829225.app.jwtExpirationMs}")
